...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/truthordare',
        'Source': 'https://github.com/apiverve/truthordare-api',
        'Bug Tracker': 'https://github.com/apiverve/truthordare-api/issues'
    },
    classifiers=[
