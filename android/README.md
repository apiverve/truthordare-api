...
```gradle
dependencies {
    implementation 'com.github.apiverve:truthordare-api:1.1.14'
}
```
...
```java
import com.apiverve.truthordare.TruthorDareAPIClient;
import com.apiverve.truthordare.APIResponse;
import com.apiverve.truthordare.APIException;

// Initialize the client
TruthorDareAPIClient client = new TruthorDareAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/truthordare](https://docs.apiverve.com/ref/truthordare)
...
- **Documentation:** [https://docs.apiverve.com/ref/truthordare](https://docs.apiverve.com/ref/truthordare)
- **Issues:** [GitHub Issues](https://github.com/apiverve/truthordare-api/issues)
