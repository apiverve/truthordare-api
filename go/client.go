// Package truthordare provides a Go client for the Truth or Dare API.
//
// For more information, visit: https://apiverve.com/marketplace/truthordare?utm_source=go&utm_medium=readme
package truthordare
...
const (
	baseURL        = "https://api.apiverve.com/v1/truthordare"
	defaultTimeout = 30 * time.Second
)

// Client is the Truth or Dare API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Truth or Dare API client.
...
// Execute makes a request to the Truth or Dare API with typed parameters.
//
...
//   - type: string - Prompt type: truth, dare, or random
//   - adult: boolean - Include adult/spicy prompts
