...
namespace APIVerve.API.TruthorDare
{
    ...
    /// <summary>
    /// Client for the TruthorDare API
    /// </summary>
    public class TruthorDareAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/truthordare";
        ...
        public TruthorDareAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TruthorDareAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TruthorDareAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TruthorDareQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TruthorDareQueryOptions options)
        {
        ...
        public ResponseObj Execute(TruthorDareQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TruthorDareQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TruthorDareQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TruthorDareQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TruthorDareQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TruthorDareQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TruthorDareQueryOptions options)
        {
