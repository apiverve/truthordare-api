...
class truthordareWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/truthordare');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/truthordare';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"type":{"type":"string","required":false,"default":"random"},"adult":{"type":"boolean","required":false,"default":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/truthordare`);
        }
    }
...
module.exports = truthordareWrapper;
