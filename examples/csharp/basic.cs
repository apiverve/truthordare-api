    ...
    class TruthorDareExample
    {
        ...
        static async Task<JsonDocument> CallTruthorDareAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;type&quot;] &#x3D; &quot;random&quot;, [&quot;adult&quot;] &#x3D; false };
        ...
        {
            Console.WriteLine("📤 Calling Truth or Dare API...\n");

            var result = await CallTruthorDareAPI();
